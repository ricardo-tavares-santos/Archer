...
namespace EasyMobile
{
    public class IronSourceClientImpl : AdClientImpl
    {
        ...
        protected IronSourceBannerSize mCurrentBannerAdSize = IronSourceBannerSize.SMART_BANNER;
        ...
        protected IronSourceBannerSize ToIronSourceBannerSize(IronSourceSettings.IronSourceBannerType bannerType)
        {
            switch (bannerType)
            {
                ...
                case IronSourceSettings.IronSourceBannerType.LargeBanner:
                    return IronSourceBannerSize.LARGE_BANNER;

                case IronSourceSettings.IronSourceBannerType.RectangleBanner:
                    return IronSourceBannerSize.RECTANGLE_BANNER;

                case IronSourceSettings.IronSourceBannerType.SmartBanner:
                    return IronSourceBannerSize.SMART_BANNER;
        ...
        {
            return adSize.IsSmartBanner ? IronSourceBannerSize.SMART_BANNER : ToIronSourceNearestSize(adSize);
        }
        ...
        protected virtual IronSourceBannerSize ToIronSourceNearestSize(BannerAdSize adSize)
        {
            if (adSize.Height < 70) // (50+90)/2
                ...
                return IronSourceBannerSize.LARGE_BANNER;   // screen width x 90
            else
                return IronSourceBannerSize.RECTANGLE_BANNER;   // screen width x 250
        }
